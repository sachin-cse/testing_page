...
<head>
  ...
  <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script> <!-- jQuery CDN link -->
...
<body>
  <form action="save_data.php" method="post" name="form" enctype="multipart/form-data">
    ...
    <div id="imagePreview">
      <img id="previewImg" src="" style="max-width: 200px;">
    </div>

    <br>

    <input type="submit" name="save_data" id="submitButton">
  </form>
